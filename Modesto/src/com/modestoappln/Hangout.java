...
public class Hangout extends Activity implements OnItemSelectedListener,OnClickListener{
	int i=0;
	Spinner dropdown;
	TabSpec t1,t2,t3;
	TabHost th;
	ImageView iv1,iv2,iv3;
	String[] items = new String[]{"Select","Zencafe", "Shambhoo's", "Cafelevels","JAVA+","Jaggernaut Arena","Project Cafe","Sphere Lounge"};
	...
	public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		Log.d("hello", "IN ONITEMSELECTED "+position);
	    switch(position){
	    case 0:
	    	break;
	    case 1:
	    	al1=dao.connectRestaurant("Zen Cafe","hangout");
        	...
        	iv1.setImageBitmap(decodeSampledBitmapFromResource(R.drawable.zen3,200, 200));
			
			flag2=true;
		    break;
        case 2:
        	al1=dao.connectRestaurant("Shambhoo","hangout");
        	textView.setText(Html.fromHtml("<b><u>"+al1.get(0).toString()+"'s</u></b>"));
        	textView1.setText(Html.fromHtml("<b>Address : </b>"+al1.get(1).toString()));
        	textView2.setText(Html.fromHtml("<b>Cost for single person : </b>"+al1.get(3).toString()+"Rs."));
        	textView3.setText(Html.fromHtml("<b>Contact details : </b>"+al1.get(4).toString()));
        	iv1.setImageBitmap(decodeSampledBitmapFromResource(R.drawable.shambhu,200,200));
        	
        	flag2=true;
        	break;
        case 3:
        	al1=dao.connectRestaurant("CafeLevel","hangout");
        	textView.setText(Html.fromHtml("<b><u><font color='blue'>"+al1.get(0).toString()+"</font></u></b>"));
        	textView1.setText(Html.fromHtml("<b>Address : </b>"+al1.get(1).toString()));
        	textView2.setText(Html.fromHtml("<b>Cost for single person : </b>"+al1.get(3).toString()+"Rs."));
        	textView3.setText(Html.fromHtml("<b>Contact details : </b>"+al1.get(4).toString()));
        	iv1.setImageBitmap(decodeSampledBitmapFromResource(R.drawable.cafelevel,200,200));
        	
        	flag2=true;
        	break;
        case 4:
        	al1=dao.connectRestaurant("JAVA+","hangout");
        	textView.setText(Html.fromHtml("<b><u><font color='blue'>"+al1.get(0).toString()+"</font></u></b>"));
        	textView1.setText(Html.fromHtml("<b>Address : </b>"+al1.get(1).toString()));
        	textView2.setText(Html.fromHtml("<b>Cost for single person : </b>"+al1.get(3).toString()+"Rs."));
        	textView3.setText(Html.fromHtml("<b>Contact details : </b>"+al1.get(4).toString()));
        	iv1.setImageBitmap(decodeSampledBitmapFromResource(R.drawable.java,200,200));
        	
        	flag2=true;
        	break;
        case 5:
        	al1=dao.connectRestaurant("Jaggernaut Arena","hangout");
        	textView.setText(Html.fromHtml("<b><u><font color='blue'>"+al1.get(0).toString()+"</font></u></b>"));
        	textView1.setText(Html.fromHtml("<b>Address : </b>"+al1.get(1).toString()));
        	textView2.setText(Html.fromHtml("<b>Cost for single person : </b>"+al1.get(3).toString()+"Rs."));
        	textView3.setText(Html.fromHtml("<b>Contact details : </b>"+al1.get(4).toString()));
        	iv1.setImageBitmap(decodeSampledBitmapFromResource(R.drawable.jugger4,200,200));
        	
        	flag2=true;
        	break;
        case 6:
        	al1=dao.connectRestaurant("Project Cafe","hangout");
        	textView.setText(Html.fromHtml("<b><u><font color='blue'>"+al1.get(0).toString()+"</font></u></b>"));
        	textView1.setText(Html.fromHtml("<b>Address : </b>"+al1.get(1).toString()));
        	textView2.setText(Html.fromHtml("<b>Cost for single person : </b>"+al1.get(3).toString()+"Rs."));
        	textView3.setText(Html.fromHtml("<b>Contact details : </b>"+al1.get(4).toString()));
        	iv1.setImageBitmap(decodeSampledBitmapFromResource(R.drawable.project3,200,200));
        	
        	flag2=true;
        	break;
        case 7:
        	al1=dao.connectRestaurant("Sphere Lounge","hangout");
        	textView.setText(Html.fromHtml("<b><u><font color='blue'>"+al1.get(0).toString()+"</font></u></b>"));
        	textView1.setText(Html.fromHtml("<b>Address : </b>"+al1.get(1).toString()));
        	textView2.setText(Html.fromHtml("<b>Cost for single person : </b>"+al1.get(3).toString()+"Rs."));
        	textView3.setText(Html.fromHtml("<b>Contact details : </b>"+al1.get(4).toString()));
        	iv1.setImageBitmap(decodeSampledBitmapFromResource(R.drawable.sphere1,200,200));
