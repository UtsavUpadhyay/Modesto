...
public class Restaurant extends Activity implements OnItemSelectedListener,OnClickListener{
	int i=0;
	Spinner dropdown;
	TabSpec t1,t2,t3;
	TabHost th;
	ImageView iv1,iv2,iv3;
	String[] items = new String[]{"Select","Alimentos", "Atithi Restaurant", "Autograph - Armoise Hotel","Bawarchi Restaurant","Cellad Eatery","Kabir Restaurant","Saffron Restaurant"};
	...
	public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2,
	    ...
	    case 0:
	    	break;
        case 1:
        	al1=dao.connectRestaurant("Alimentos","restaurant");
        	...
        	iv1.setImageBitmap(decodeSampledBitmapFromResource(R.drawable.ali1,200, 200));
			
			flag2=true;
		    break;
        case 2:
        	al1=dao.connectRestaurant("Atithi Restaurant","restaurant");
        	textView.setText(Html.fromHtml("<b><u><font color='blue'>"+al1.get(0).toString()+"</font></u></b>"));
        	textView1.setText(Html.fromHtml("<b>Address : </b>"+al1.get(1).toString()));
        	textView2.setText(Html.fromHtml("<b>Cost for single person : </b>"+al1.get(3).toString()+"Rs."));
        	textView3.setText(Html.fromHtml("<b>Contact details : </b>"+al1.get(4).toString()));
        	iv1.setImageBitmap(decodeSampledBitmapFromResource(R.drawable.atithi4,200,200));
        	
        	flag2=true;
        	break;
        case 3:
        	al1=dao.connectRestaurant("Autograph - Armoise Hotel","restaurant");
        	textView.setText(Html.fromHtml("<b><u><font color='blue'>"+al1.get(0).toString()+"</font></u></b>"));
        	textView1.setText(Html.fromHtml("<b>Address : </b>"+al1.get(1).toString()));
        	textView2.setText(Html.fromHtml("<b>Cost for single person : </b>"+al1.get(3).toString()+"Rs."));
        	textView3.setText(Html.fromHtml("<b>Contact details : </b>"+al1.get(4).toString()));
        	iv1.setImageBitmap(decodeSampledBitmapFromResource(R.drawable.uto1,200,200));
        	
        	flag2=true;
        	break;
        case 4:
        	al1=dao.connectRestaurant("Bawarchi Restaurant","restaurant");
        	textView.setText(Html.fromHtml("<b><u><font color='blue'>"+al1.get(0).toString()+"</font></u></b>"));
        	textView1.setText(Html.fromHtml("<b>Address : </b>"+al1.get(1).toString()));
        	textView2.setText(Html.fromHtml("<b>Cost for single person : </b>"+al1.get(3).toString()+"Rs."));
        	textView3.setText(Html.fromHtml("<b>Contact details : </b>"+al1.get(4).toString()));
        	iv1.setImageBitmap(decodeSampledBitmapFromResource(R.drawable.bawarchi3,200,200));
        	
        	flag2=true;
        	break;
        case 5:
        	al1=dao.connectRestaurant("Cellad Eatery","restaurant");
        	textView.setText(Html.fromHtml("<b><u><font color='blue'>"+al1.get(0).toString()+"</font></u></b>"));
        	textView1.setText(Html.fromHtml("<b>Address : </b>"+al1.get(1).toString()));
        	textView2.setText(Html.fromHtml("<b>Cost for single person : </b>"+al1.get(3).toString()+"Rs."));
        	textView3.setText(Html.fromHtml("<b>Contact details : </b>"+al1.get(4).toString()));
        	iv1.setImageBitmap(decodeSampledBitmapFromResource(R.drawable.cellad1,200,200));
        	
        	flag2=true;
        	break;
        case 6:
        	al1=dao.connectRestaurant("Kabir Restaurant","restaurant");
        	textView.setText(Html.fromHtml("<b><u><font color='blue'>"+al1.get(0).toString()+"</font></u></b>"));
        	textView1.setText(Html.fromHtml("<b>Address : </b>"+al1.get(1).toString()));
        	textView2.setText(Html.fromHtml("<b>Cost for single person : </b>"+al1.get(3).toString()+"Rs."));
        	textView3.setText(Html.fromHtml("<b>Contact details : </b>"+al1.get(4).toString()));
        	iv1.setImageBitmap(decodeSampledBitmapFromResource(R.drawable.abir,200,200));
        	
        	flag2=true;
        	break;
        case 7:
        	al1=dao.connectRestaurant("Saffron Restaurant","restaurant");
        	textView.setText(Html.fromHtml("<b><u><font color='blue'>"+al1.get(0).toString()+"</font></u></b>"));
        	textView1.setText(Html.fromHtml("<b>Address : </b>"+al1.get(1).toString()));
        	textView2.setText(Html.fromHtml("<b>Cost for single person : </b>"+al1.get(3).toString()+"Rs."));
        	textView3.setText(Html.fromHtml("<b>Contact details : </b>"+al1.get(4).toString()));
        	iv1.setImageBitmap(decodeSampledBitmapFromResource(R.drawable.saff4,200,200));
