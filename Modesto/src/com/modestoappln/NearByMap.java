...
public class NearByMap extends FragmentActivity implements LocationListener,OnMarkerClickListener,OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapTypeN=(Button) findViewById(R.id.dropdownmenuNearbyMapLinearBtn1);
        mapTypeT=(Button) findViewById(R.id.dropdownmenuNearbyMapLinearBtn2);
        mapTypeS=(Button) findViewById(R.id.dropdownmenuNearbyMapLinearBtn3);
        mapTypeH=(Button) findViewById(R.id.dropdownmenuNearbyMapLinearBtn4);
        ...
        spinPlace = (Spinner) findViewById(R.id.spr_place_type);
        Log.d("hello", "spinner and adapter  :"+ spinPlace+"   kklxlklxk   "+ adapter.toString());
        ...
        if(status!=ConnectionResult.SUCCESS){
            ...
            btnFind.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    int selectedPosition = spinPlace.getSelectedItemPosition();
                    type = placeType[selectedPosition];
                    Log.d("hello", "type selected :  "+type);
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<HashMap<String,String>>>{
        ...
        protected void onPostExecute(List<HashMap<String,String>> list){
            ...
            for(int i=0;i<list.size();i++){
                ...
                String photoRef=hmPlace.get("photo_ref");
                
                Integer width =Integer.parseInt(hmPlace.get("width"));
                
                double rating =Double.parseDouble(hmPlace.get("rating"));
                
                Log.d("hello", "here is photoref  : "+photoRef+"  width  "+width+"   rating   "+rating);
                ...
                markerOptions.title(name + ":" + vicinity +":"+ rating +":"+ width +":"+ photoRef);
                ...
                gm.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
					...
					public void onInfoWindowClick(Marker marker) {
						...
						intentData.clear();
						Log.d("hello", "inside listener :    "+marker.getTitle());
						Log.d("hello", "title is :    "+marker.getTitle());
						intentData.add(marker.getTitle());
						intentData.add(type);
						Intent in=new Intent("com.modestoappln.Review");
						in.putStringArrayListExtra("data", intentData);
						startActivity(in);
					}
				});
            }
